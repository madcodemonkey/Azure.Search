...
public static class ServiceCollectionExtensions
{
    ...
    {
        string[] optionalPropertyNames = new []{ nameof(CognitiveSettings.ServicesEndpoint), nameof(CognitiveSettings.ServicesKey) };
        ConfigureSectionSettings<CognitiveSettings>(sc, config, CognitiveSettings.SectionName, true, optionalPropertyNames);
        ...
        sc.AddScoped<ICogSearchSkillSetService, CogSearchSkillSetService>();
