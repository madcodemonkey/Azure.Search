...
public class OutOfBoxIndexService : IOutOfBoxIndexService
{
    ...
    /// Constructor
    /// </summary>
    public OutOfBoxIndexService(ServiceSettings serviceSettings, 
    ...
    private async Task CreateDataSource()
    {
        ...
        await _dataSourceService.CreateForBlobAsync(_serviceSettings.CognitiveSearchDataSourceName,
            _serviceSettings.CognitiveSearchStorageContainerName,
            _serviceSettings.CognitiveSearchStorageConnectionString,
            null, null);
