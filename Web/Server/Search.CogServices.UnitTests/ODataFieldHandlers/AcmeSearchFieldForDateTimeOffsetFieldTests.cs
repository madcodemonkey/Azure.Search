...
[TestClass]
public class AcmeSearchODataHandlerDateTimeOffsetTests
{
    ...
    {
        // Arrange
        var cut = new AcmeSearchODataHandlerDateTimeOffset();
    ...
    public void CreateFilter_ExactDateAndTimePassedIn_TurnedIntoUtcTime()
    {
        ...
        // Act
        var actualResult = cut.CreateFilter(IndexFieldName, AcmeSearchFilterOperatorEnum.Equal, values);
