...
/// override the method and then in the dependency injection they can register their override in place of  <see cref="IAcmeOptionsService"/>  </summary>
public class AcmeOptionsService : IAcmeOptionsService
{
