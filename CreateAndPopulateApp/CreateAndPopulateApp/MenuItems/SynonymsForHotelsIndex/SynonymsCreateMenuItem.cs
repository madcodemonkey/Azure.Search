...
public class SynonymsCreateMenuItem : IConsoleMenuItem
{
    private readonly IPromptHelper _promptHelper;
    private readonly ISearchSynonymService _synonymService;
    private readonly string _defaultMapName;

    public SynonymsCreateMenuItem(IConfiguration configuration, IPromptHelper promptHelper, ISearchSynonymService synonymService)
    {
